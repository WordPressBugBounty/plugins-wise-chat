 ...
 */
class VideoStreamsTab extends AbstractTab {
	...
	public function getProFields() {
		return array('video_calls_enabled', 'video_calls_calling_timeout', 'twilio_account_sid', 'twilio_api_key_sid', 'twilio_api_key_secret',
			'video_calls_calling_sound_enabled', 'video_calls_incoming_call_sound_enabled', 'twilio_video_room_media_region'
		);
	}
