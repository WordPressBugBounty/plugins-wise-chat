 ...
 */
class ModesTab extends AbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('classic_disable_channel', 'Disable Public Channels', 'booleanFieldCallback', 'boolean',
				'Disables all public channels and private groups. Only direct chats are possible.<br />
			...
			array('browser_location', 'Browser Location', 'selectCallback', 'string', 'The location of <a href="https://kaine.pl/projects/wp-plugins/wise-chat-pro/faq/what-exactly-is-a-browser-i-found-this-in-the-chats-configuration/" target="_blank">the browser</a>.', self::getUsersListLocation()),
	...
	public function getProFields() {
        return array(
        	'fb_disable_channel', 'fb_location', 'fb_channel_width', 'fb_channel_height',
