 ...
 */
class MessagesTab extends AbstractTab {
	...
	public function getFields() {
		return array(
			...
			array('sound_notification', 'New Message Sound', 'selectCallback', 'string', 'Plays a sound when new messages arrive.', MessagesTab::getNotificationSounds()),
			array('sound_notification_mode', 'New Message Sound Mode', 'selectCallback', 'string', 'Choose what messages should be notified', MessagesTab::getMessageTypes()),
			array('chat_sound_notification', 'New Chat Sound', 'selectCallback', 'string', 'Plays a sound when new chat opens.', MessagesTab::getNotificationSounds()),
			...
			array('join_sound_notification', 'User Online Sound', 'selectCallback', 'string', 'Plays a sound when user becomes online.', MessagesTab::getNotificationSounds()),
			...
			array('leave_sound_notification', 'User Offline Sound', 'selectCallback', 'string', 'Plays a sound when user becomes offline.', MessagesTab::getNotificationSounds()),
			array('mentioning_sound_notification', 'Mentioning Sound', 'selectCallback', 'string', 'Plays a sound when user is mentioned using <i>@UserName:</i> notation.', MessagesTab::getNotificationSounds()),
	...
	public function getProFields() {
		return array('enable_voice_messages', 'voice_message_max_length', 'voice_message_mp3_bitrate');
	}
